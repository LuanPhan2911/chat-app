...
const ProfileDrawer: FunctionComponent<ProfileDrawerProps> = ({
  data,
  isOpen,
  onClose,
}) => {
  ...
  }, [data.isGroup, data.users.length, members, otherUser.email]);
  return (
    <>
      <ConfirmModal
        isOpen={showConfirm}
                      ...
                      <div className="relative mt-6 flex-1 px-4 sm:px-6">
                        <div className="flex flex-col items-center">
                          ...
                          cursor-pointer hover:opacity-75"
                            >
                              <div
                                className="h-10w-10 bg-neutral-100 rounded-full 
